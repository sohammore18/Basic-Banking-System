...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:skyblue; opacity:1;"> 
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:white;font-weight:1em;font-size: 20px;">
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:skyblue;font-size:2.2em;padding:3%;font-family: 'Nunito';">Customers</h3>
    <table id ="myTable">
          <tr>
            <th style="color:black">Customer ID</th>
            <th style="color:black">Name</th>
            <th style="color:black">Email</th>
            <th style="color:black">Current Balance</th>
            <th>&nbsp;</th>
          </tr>
          <?php
