...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" height="50px" href="./images/1.webp">
</head>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:skyblue; background-color:skyblue; opacity:1;"> 
