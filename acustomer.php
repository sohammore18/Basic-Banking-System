...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:skyblue; opacity:1;"> 
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:white;font-family: 'Times New Roman';font-size:2.5em;">
                &nbsp;WILTON BANK
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:white;font-weight:1em;font-size: 20px;font-family: 'Nunito';">
                            <div style="padding-right:0px;" >
                                
                            </div>
                            <span style="padding-right:20px;font-family: 'Nunito';" >&nbsp;&nbsp;Home</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:white;font-weight:1em;font-size: 20px;font-family: 'Nunito';">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:white;font-weight:1em;font-size: 20px;font-family: 'Nunito';">
                            <div style="padding-left:20px;" >
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:skyblue;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:skyblue;font-size:1.8em;line-height:1em;font-family: 'Nunito';display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
                    <b style="font-size:1.2em;">Sender</b> : <span style="font-size:1.2em;font-family: 'Nunito';"><input id="myinput" name="sender" disabled type="text" style="width:40%;border:none;" value='<?php echo "$user";?>'></input></span>
